...
class CustomARView: ARView {
    ...
    func setupEntities() {
       testSphere = makeSphereEntity(name: "sphere", radius: 0.05, imageName: "6")
        
        testBox = makeBoxEntity(name: "box", width: 0.5, height: 0.5, depth: 0.5, imageName: "6")
        
        
        
      guitar = makeModelEntity(name: "plane", usdzModelName: "b1")
    }
